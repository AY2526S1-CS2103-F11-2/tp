...
public class EditCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = "Please follow the format as follows: \n"
    ...
    public static class EditPersonDescriptor {
        ...
        public boolean isAnyFieldEdited() {
            return CollectionUtil.isAnyNonNull(name, telehandle, instrument, comment, rating, tags);
        }
