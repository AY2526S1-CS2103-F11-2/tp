...
public class FindCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Finds all persons whose names, instruments, Telegram "
            + "handles, ratings, or tags contain any of the specified keywords (case-insensitive) and displays them "
